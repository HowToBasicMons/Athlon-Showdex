...
export const FormatLabels: Record<string, string> = {
  ...
  soulstonesou: 'Soulstones OU',
  soulstonesubers: 'Soulstones Ubers',
  soulstonesuu: 'Soulstones UU',
  soulstoneslc: 'Soulstones LC',
  soulstonesag: 'Soulstones AG',
  soulstonesmonotype: 'Soulstones Monotype',
  soulstonesdoublesou: 'Soulstones Doubles OU',
  soulstonesdoublesag: 'Soulstones Doubles AG',
  soulstonesrandombattle: 'Soulstones Randoms',
  soulstonescustomgame: 'Soulstones Customs',
